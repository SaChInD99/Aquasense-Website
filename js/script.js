    ...
    var debounce = function (func, threshold, execAsap) {
        ...
        return function debounced () {
            ...
            if (timeout)
                ...
                func.apply(obj, args);
                timeout = setTimeout(fgt_sslvpn.eval_rewrite(delayed), threshold || 100);
        };
    }
...
$('a[href*=#]:not([href=#])').click(function() {
    if (fgt_sslvpn.pathname_restore(location).replace(/^\//,'') == fgt_sslvpn.pathname_restore(this).replace(/^\//,'') &&  fgt_sslvpn.hostname_restore(location)== fgt_sslvpn.hostname_restore(this)) {
